...
export const ReparacionPresupuesto: React.FC<ReparacionPresupuestoProps> = ({ 
    ...
    return (
        <SectionCard title="PRESUPUESTO" id="seccion-presupuesto">
            ...
            <FormField
                ...
                type="number"
                value={presuMo.value}
                onChange={presuMo.onChange}
                isSaving={presuMo.isSaving}
                disabled={!isAdmin}
            />
            <FormField
                label="Adelanto $"
                ...
                type="number"
                value={presuRe.value}
                onChange={presuRe.onChange}
                isSaving={presuRe.isSaving}
                disabled={!isAdmin}
            />
            <div>
                <FormField
                    ...
                    type="number"
                    value={presuFi.value}
                    onChange={presuFi.onChange}
                    isSaving={presuFi.isSaving}
                    disabled={!isAdmin}
                    placeholder="El precio se calcula automáticamente en base a las intervenciones, o puede ingresar un valor manual"
                />
            ...
            {isAdmin && (
                <div className="mt-3">
                    {intervencionesAplicadas.length > 0 && (
                        <div className="mb-3">
                            <div className="d-flex flex-wrap gap-2">
                                <AppButton variant="primary" onClick={enviarPresupuesto}>
                                    <i className="bi bi-envelope me-2"></i>
                                    Enviar por Email
                                </AppButton>
                                <AppButton variant="secondary" onClick={generarPDF}>
                    ...
                    {puedeAvanzarAPresupuestado && (
                        <div className="mb-2">
                            <AppButton variant="warning" onClick={avanzarAPresupuestado}>
